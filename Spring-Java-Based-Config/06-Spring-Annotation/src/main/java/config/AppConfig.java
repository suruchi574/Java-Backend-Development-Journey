...
public class AppConfig {
	...
	/*
	 * No need of doing all configuration manually here 
	 * Spring can do this for us 
	 * We just have to use some annotation like
	 * @Component -> Above class name
	 * @ComponentScan -> Above AppConfig Class
	 * We have to mention package name in ComponentScan 
	 * so that spring can get the location of classes
	 *  */
//	
//
//    /*
